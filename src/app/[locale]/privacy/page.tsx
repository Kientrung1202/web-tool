...
export default async function PrivacyPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const sections = [
    { title: "privacySectionBrowser", body: "privacyBrowserBody" },
    { title: "privacySectionServer", body: "privacyServerBody" },
    { title: "privacySectionCookies", body: "privacyCookiesBody" },
    { title: "privacySectionAnalytics", body: "privacyAnalyticsBody" },
    { title: "privacySectionChildren", body: "privacyChildrenBody" },
    { title: "privacySectionChanges", body: "privacyChangesBody" },
    { title: "privacySectionContact", body: "privacyContactBody" }
  ];
