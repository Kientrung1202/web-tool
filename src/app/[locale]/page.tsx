    ...
    <main className="mx-auto w-full max-w-6xl px-4 py-8 md:py-10">
      <section className="mb-6 rounded-lg border bg-card p-6 shadow-product md:p-10">
        <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
          ...
          {workflowBuilder ? (
            <Link
              className="inline-flex h-10 w-fit shrink-0 items-center justify-center rounded-md border bg-card px-4 text-sm font-semibold text-foreground shadow-sm transition hover:bg-accent hover:text-accent-foreground"
